        ...
        <section className="bg-gradient-to-b ">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="pt-24 pb-12 md:pt-30 md:pb-20">
              {/* Page header */}
              <div className="max-w-3xl mx-auto text-center pb-10 md:pb-1">
                <h1 className="h1">
              ...
              <div className="max-w-sm mx-auto px-4 md:px-0">
                <form onSubmit={handleSubmit(onSubmit)} className="mt-8">
                  ...
                  <div className="flex flex-wrap -mx-3 mt-6">
                    <div className="w-full px-3">
                      <button className="btn text-gray-100 bg-custom-100 hover:bg-gray-200 hover:text-custom-100 w-full">
                        Sign up
                      </button>
                    </div>
                  </div>
                  <div className="text-sm  text-center mt-3">
                    ...
                    <a className="underline text-custom-100" href="#0">
                      terms & conditions
                    </a>
                    , and our{" "}
                    <a className="underline text-custom-100" href="#0">
