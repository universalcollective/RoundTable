...
function FeaturesBlocks() {
  ...
  return (
    <section className={`relative ${isNightMode ? 'bg-slate-800 text-gray-100' : 'bg-gray-100 text-gray-700'}`}>
      ...
      <div className="absolute left-0 right-0 bottom-0 m-auto w-px p-px h-20 bg-gray-100 transform translate-y-1/2"></div> */}
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className={`max-w-3xl mx-auto text-center pb-12 md:pb-20 ${isNightMode ? 'bg-slate-800 text-gray-100' : 'bg-gray-100 text-gray-700'}`}>
            <h2 className="h2 mb-4">How Round Table works</h2>
            <p className="text-xl">
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            {/* 1st item */}
            <div className={`relative flex flex-col items-center p-6 ${isNightMode ? 'bg-gray-100 text-custom-100' : 'bg-gray-100 text-gray-700'} rounded shadow-xl`}>
              <svg
